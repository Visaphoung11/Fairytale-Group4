...
export default function RegisterForm() {
  ...
  return (
    <div
      className="flex flex-col min-h-screen bg-opacity-80 bg-cover bg-center bg-no-repeat"
      style={{
        backgroundImage: `url(${RegisterBg})`,
      }}
    >
      <div className="flex-grow flex mt-30 sm:mt-10 items-center justify-center">
